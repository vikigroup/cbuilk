        ...
        //	$dongia=round(($dongia/($tl*1000)),2); // cap nhat ti gia
            ...
            <table width="100%" cellspacing="0" cellpadding="3" class="sty_table_rv">
                ...
                <tr class="tongket">
                    ...
                    <td colspan="3" align="center"><a href="<?php echo $host_link_full?>/dat-hang.html"><img src="<?php echo $host_link_full ;?>/skin/temp<?php echo $url;?>/imgs/layout/btn-mua-hang.jpg" border="0" /></a> &nbsp;&nbsp;&nbsp;<a href="<?=$_SERVER['HTTP_REFERER'];?>"><img src="<?php echo $host_link_full ;?>/skin/temp<?php echo $url;?>/imgs/layout/btn-tiep-tuc-mua.jpg" alt=""/></a></td>
                </tr>
            </table>
