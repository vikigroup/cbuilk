<?php
	...
	$noidung_AltBody='
	Chào bạn! <br>
	Email này là do khách hàng đã đặt hàng thành thành công trên '."
	Đơn đặt hàng: <br>
	<hr>
	Khách hàng: '{$name}' <br>
	...
	"
	.'<br><br> <hr>
			Mong bạn thực hiện giao dịch thành công, chúc công việc kinh doanh của bạn ngày càng thuận lợi." vào trong Email. <br>';
...
#noidung {
 ...
 <?php 
	...
	$tieude_Subject="Email do khách hàng liên hệ từ website";
