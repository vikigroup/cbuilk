<div class="menu_mau_gh">
    ...
    <ul class="nav_menu_mau_gh">
        	...
        	<ul class="menu_child">
                ...
                <li>
                    ...
                    <ul class="menu_2_child">
                        ...
                        ?>
                        <li><a href="/<?php echo $row_cate['subject']?>.html" title=""><?php echo $row_cate1['name'];?></a></li>
                        <?php } ?>
                    </ul><!-- End .menu_2_child -->
                    <?php }?>
                </li>
        ...
        <li <?php if($frame=="sanpham") echo 'class="curren"';?> >
        	<a href="<?php if( $row_news['link']==""){?><?php echo $row_news['subject'];?>.html<?php }else {echo $row_news['link'];}?>" title=""><?php echo $row_news['name'];?></a>  
        </li>
        <li><span class="line_menu"></span></li>
        <?php }?>
