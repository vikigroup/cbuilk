...
<!--[if IE 6]>
    <script src="text/javascript" src="skin/temp<?php echo $url;?>/scripts/DD_belatedPNG_0.0.8a.js"></script>
    <script>
      DD_belatedPNG.fix('img, div, span, a, h1, h2, h3, h4, h5, h6, p, table, input');
    </script>
<![endif]-->
<!--[if lt IE 9]>
	<link rel="stylesheet" type="text/css" href="text/javascript" src="skin/temp<?php echo $url;?>/templates/jquery.slider.ie6.css" />
	<link rel="stylesheet" type="text/css" href="text/javascript" src="skin/temp<?php echo $url;?>/templates/FIX_IE.css" />
<![endif]-->
