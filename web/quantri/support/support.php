        ...
        <div class="filter_num">
            ...
            <div class="filter_btn">
                ...
                <div class="add_news_all">                                
                    <a href="index.php?act=support_m" title=""><span class="icon_add_news_all"></span>Thêm mới hỗ trợ</a>
       ...
       // $pageindex = createPage(countRecord("tbl_support",$where),"./?act=shop_category&cat=".$_REQUEST['cat']."&page=",$MAXPAGE,$page)?>
        ...
        <? if ($_REQUEST['code']==1) $errMsg = 'Cập nhật thành công.';echo $errMsg;?>
            <table width="100%" border="1">
                ...
                $parent = getRecord('tbl_support_category','id = '.$row['parent']);
                ...
                ?>
                    <tr>
                        ...
                        <td>
							Tên       :<?=$row['name']?><br />
                        	Nick yahoo: <?=$row['nickyahoo']?><br />
                            Nick skype: <?=$row['nickskype']?>
                        
                        </td>
                        <td align="center"><img src="imgs/layout/anhien_<?=$row['status']?>.png" class="anhien" title="Ẩn hiện"value="<?=$row['id']?>" alt=""/></td>
                        <td align="center">
                            <a href="index.php?act=support&action=del&page=<?=$_REQUEST['page']?>&id=<?=$row['id']?>" title="Xóa"  onclick="return confirm('Bạn có muốn xoá luôn không ?');" ><img src="imgs/layout/xoa.png" alt=""/></a>
                            &nbsp;
                            <a href="index.php?act=support_m&cat=<?=$_REQUEST['cat']?>&page=<?=$_REQUEST['page']?>&id=<?=$row['id']?>" title="Sửa"><img src="imgs/layout/sua.png" alt=""/></a>
                        </td>
                    </tr>
                   <?php }?>
