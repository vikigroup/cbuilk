...
{ 
	...
	$_SESSION['kt_tukhoa_slider']=$tukhoa;
...
if (isset($_POST['reset'])==true) {
	...
	$_SESSION['kt_tukhoa_slider']=-1;
}
if($_SESSION['kt_tukhoa_slider']==NULL){$tukhoa=-1;}
if($_SESSION['kt_tukhoa_slider']!=NULL){$tukhoa=$_SESSION['kt_tukhoa_slider'];}
?>
<script>
...
<div class="main_cont_body">
    ...
    <h1 class="title_menu_admin">Slider</h1><!-- End .title_menu_admin -->
    ...
    <div class="frame_cont_body">    
        ...
        <div class="filter_num">
            ...
            <div class="filter_btn">
                ...
                <div class="add_news_all">                                
                    <a href="index.php?act=slider_m" title=""><span class="icon_add_news_all"></span>Thêm mới sản phẩm</a>
        ...
        switch ($_GET['action']){
            case 'del' :
				...
				if($r['idshop']==$idshop){
					$resultParent = mysql_query("select id from tbl_slider where parent='".$id."'",$conn);
       ...
       // $pageindex = createPage(countRecord("tbl_slider",$where),"./?act=shop_category&cat=".$_REQUEST['cat']."&page=",$MAXPAGE,$page)?>
        ...
        <? if ($_REQUEST['code']==1) $errMsg = 'Cập nhật thành công.';echo $errMsg;?>
            <table width="100%" border="1">
                ...
                $parent = getRecord('tbl_slider_category','id = '.$row['parent']);
                ...
                ?>
                    <tr>
                        ...
                        <td align="center">
                            <a href="index.php?act=slide&action=del&page=<?=$_REQUEST['page']?>&id=<?=$row['id']?>" title="Xóa"  onclick="return confirm('Bạn có muốn xoá luôn không ?');" ><img src="imgs/layout/xoa.png" alt=""/></a>
                            &nbsp;
                            <a href="index.php?act=slider_m&cat=<?=$_REQUEST['cat']?>&page=<?=$_REQUEST['page']?>&id=<?=$row['id']?>" title="Sửa"><img src="imgs/layout/sua.png" alt=""/></a>
                        </td>
                    </tr>
                   <?php }?>
