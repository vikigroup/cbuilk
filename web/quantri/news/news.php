...
{ 
	...
	$_SESSION['kt_tukhoa_news']=$tukhoa;
...
if (isset($_POST['reset'])==true) {
	...
	$_SESSION['kt_tukhoa_news']=-1;
}
if($_SESSION['kt_tukhoa_news']==NULL){$tukhoa=-1;}
if($_SESSION['kt_tukhoa_news']!=NULL){$tukhoa=$_SESSION['kt_tukhoa_news'];}
?>
<script>
...
<div class="main_cont_body">
    ...
    <h1 class="title_menu_admin"> Tin mới</h1><!-- End .title_menu_admin -->
        ...
        <div class="filter_num">
            ...
            <div class="filter_btn">
                ...
                <div class="add_news_all">                                
                    <a href="index.php?act=news_m" title=""><span class="icon_add_news_all"></span>Thêm mới tin mới</a>
            ...
            <table width="100%" border="1">
                ...
                ?>
                    <tr>
                        ...
                        <td><?=$row['name']?></td>
                        <td valign="middle"><?=$parent['name']?></td>
                        ...
                        <td align="center">
                            <a href="index.php?act=news&action=del&page=<?=$_REQUEST['page']?>&id=<?=$row['id']?>" title="Xóa"  onclick="return confirm('Bạn có muốn xoá luôn không ?');" ><img src="imgs/layout/xoa.png" alt=""/></a>
                            &nbsp;
                            <a href="index.php?act=news_m&cat=<?=$_REQUEST['cat']?>&page=<?=$_REQUEST['page']?>&id=<?=$row['id']?>" title="Sửa"><img src="imgs/layout/sua.png" alt=""/></a>
                        </td>
                    </tr>
                   <?php }?>
