...
<div class="main_cont_body">
    ...
    <h1 class="title_menu_admin">Chuyên mục tin tức</h1><!-- End .title_menu_admin -->
        ...
        <div class="filter_num">
            ...
            <div class="filter_btn">
                ...
                <div class="add_news_all">                                
                    <a href="index.php?act=news_category_m" title=""><span class="icon_add_news_all"></span>Thêm mới sản phẩm</a>
            ...
            <table width="100%" border="1">
                ...
                ?>
                    <tr>
                        ...
                        <td align="center">
                            <a href="index.php?act=news_category&action=del&page=<?=$_REQUEST['page']?>&id=<?=$row['id']?>" title="Xóa"  onclick="return confirm('Bạn có muốn xoá luôn không ?');" ><img src="imgs/layout/xoa.png" alt=""/></a>
                            &nbsp;
                            <a href="index.php?act=news_category_m&cat=<?=$_REQUEST['cat']?>&page=<?=$_REQUEST['page']?>&id=<?=$row['id']?>" title="Sửa"><img src="imgs/layout/sua.png" alt=""/></a>
                        </td>
                    </tr>
                   <?php }?>
