                ...
                <div class="widget-block">
                    ...
                    switch ($_GET['action']){
                        ...
                        case 'del' :
                            ...
                            $r = getRecord("jbs_news","id=".$id);
    
                            $resultParent = 0;
    
                          
    
                                @$result = mysql_query("delete from jbs_news where id='".$id."'",$conn);
                    ...
                    $totalRows=countRecord("jbs_news",$where);
    
                    
    
                    if ($_REQUEST['cat']!='') $where="parent=".$_REQUEST['cat']; ?>
    
                    <form method="POST" action="admin.php?act=jbsnews" name="frmForm" enctype="multipart/form-data">
    
                    <input type="hidden" name="page" value="<?=$page?>">
    
                    <input type="hidden" name="act" value="jbsnews">
                        ...
                        <table width="100%"  class="admin_table">
                            ...
                            <thead>
                                ...
                                <tr align="center" >
                                  <td valign="middle" style="background-color:#F0F0F0; height:40px; padding-left:20px" colspan="10">  
                                        ...
                                        <select name="ddCatch" id="ddCatch" class="list_tim_loc"> 
                                            ...
                                            <option value="<?php echo $parent1=$_POST['ddCatch'] ; ?>"><?php echo get_field('jbs_news_category','id',$parent1,'name'); ?> </option> 
                                            <?php }?>
                               ...
                               <tr>
                                ...
                                <tr class="admin_tieude_table">
                                    ...
                                    <td width="158" align="center"><span class="title"><a class="title" >Hình</a></span></td>
    
                                    <td width="223" align="center"><a class="title" href="<?=getLinkSort(3)?>">Tên </a></td>
                                    <td width="147" align="center"><a class="title" href="<?=getLinkSort(3)?>">Tên danh mục</a></td>
    
                                    <td width="71" align="center"><a class="title" href="<?=getLinkSort(10)?>">Thứ tự </a></td>
    
                                    <td width="97" align="center"><a class="title" href="<?=getLinkSort(15)?>">Tiêu biểu</a></td>
    
                                    <td width="67" align="center"><span class="title"><a class="title" href="<?=getLinkSort(11)?>"> Ẩn hiện</a></span></td>
    
                                    <td width="114" align="center"><a class="title" href="<?=getLinkSort(12)?>">Ngày tạo lập</a></td>                                        
                            ...
                            $direction=($_REQUEST['direction']==''||$_REQUEST['direction']=='0'?"desc":"");
                             ...
                             $sql="select *,DATE_FORMAT(date_added,'%d/%m/%Y %h:%i') as dateAdd,DATE_FORMAT(last_modified,'%d/%m/%Y %h:%i') as dateModify from jbs_news where  $where $sortby  limit ".($startRow).",".$pageSize;
                            ...
                            $parent = getRecord('jbs_news','id = '.$row['parent']);
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <td align="center"><?php echo get_field('jbs_news_category','id',$row['parent'],'name');?></td>
                                    ...
                                    <td align="center">
                                        ...
                                        <a href="admin.php?act=jbsnews_m&cat=<?=$_REQUEST['cat']?>&page=<?=$_REQUEST['page']?>&id=<?=$row['id']?>"><img src="images/icon3.png"/></a>
    
                                        <a  title="Xóa" href="admin.php?act=jbsnews&action=del&page=<?=$_REQUEST['page']?>&id=<?=$row['id']?>" onclick="return confirm('Bạn có muốn xoá luôn không ?');" ><img src="images/icon4.png" width="20" border="0" /></a>
