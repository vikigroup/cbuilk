    ...
    <div class="span12">
        <div class="box-widget">
            ...
            <div class="widget-container">
                ...
                <form method="POST" action="admin.php?act=slider" name="frmForm" enctype="multipart/form-data">
               ...
               // $pageindex = createPage(countRecord("tbl_slider",$where),"./?act=shop_category&cat=".$_REQUEST['cat']."&page=",$MAXPAGE,$page)?>
                ...
                <? if ($_REQUEST['code']==1) $errMsg = 'Cập nhật thành công.'?>
                    ...
                    <table width="100%"  class="admin_table">
                            ...
                            <thead>
                               ...
                               <tr>
                                 ...
                                 <td width="81" align="center" colspan="1">
                                  <div><a href="admin.php?act=slider_m">
						...
						$sql="select *,DATE_FORMAT(date_added,'%d/%m/%Y %h:%i') as dateAdd,DATE_FORMAT(last_modified,'%d/%m/%Y %h:%i') as dateModify from tbl_slider where idshop=0 and $where $sortby $direction limit ".($startRow).",".$pageSize;
						...
						?>
                            <tr>
                                ...
                                <td align="center">
                                    <a href="admin.php?act=slider_m&cat=<?=$_REQUEST['cat']?>&page=<?=$_REQUEST['page']?>&id=<?=$row['id']?>"><img src="images/icon3.png"/></a>
                                    <a  title="Xóa" href="admin.php?act=slider&action=del&page=<?=$_REQUEST['page']?>&id=<?=$row['id']?>" onclick="return confirm('Bạn có muốn xoá luôn không ?');" ><img src="images/icon4.png" width="20" border="0" /></a><!--./?act=shop_category&action=del&page=<?=$_REQUEST['page']?>&id=<?=$row['id']?>-->
                                </td>
                            </tr>
                         <?php }?>  
                         	<tr>
