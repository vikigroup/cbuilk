...
$path = "../web/images/gianhang/ad";
$pathdb = "images/gianhang/ad";
if (isset($_POST['btnSave'])){
	...
	if ($errMsg==''){
		if (!empty($_POST['id'])){
			$oldid = $_POST['id'];
			 $sql = "update tbl_ad set name='".$name."',type='".$type."',link='".$link."',sort='".$sort."', status='".$status."',last_modified=now() where id='".$oldid."'";
		}else{
			 $sql = "insert into tbl_ad (name, type, link, sort, status,  date_added, last_modified  ) values ('".$name."','".$type."','".$link."','".$sort."','1',now(),now())";
		}
		if (mysql_query($sql,$conn)){
			...
			$result = update("tbl_ad",$arrField,"id=".$oldid);*/
			...
			if($sqlUpdateField!='')	{
				$sqlUpdate = "update tbl_ad set $sqlUpdateField where id='".$oldid."'";
        ...
        <div class="box-widget">
            ...
            <div class="widget-container">
                <div class="widget-block">
                   ...
                   <form method="post" name="frmForm" enctype="multipart/form-data" action="admin.php?act=advuser_m">
            ...
            <input type="hidden" name="act" value="advuser_m">
