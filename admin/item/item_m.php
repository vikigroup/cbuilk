...
if (isset($_POST['btnSave'])){
	...
	if ($errMsg == ''){
		if($r['type']=="0") echo '<script>window.location="admin.php?act=item&cat='.$_REQUEST['cat'].'&page='.$_REQUEST['page'].'&code=1"</script>';
		else  echo '<script>window.location="admin.php?act=item&cat='.$_REQUEST['cat'].'&page='.$_REQUEST['page'].'&code=1"</script>'; 
	}
}else{
	if (isset($_GET['id'])){
		$oldid=$_GET['id'];
        ...
        <div class="box-widget">
            ...
            <div class="widget-container">
                <div class="widget-block">
                   ...
                   <form method="post" name="frmForm" enctype="multipart/form-data" action="admin.php?act=item_m">
