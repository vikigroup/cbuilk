                    ...
                    <table width="100%"  class="admin_table">
                        ...
                        while($row = mysql_fetch_array($result)){
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    <a title="Cập nhật" href="admin.php?act=shop_post_m&cat=<?=$_REQUEST['cat']?>&page=<?=$_REQUEST['page']?>&id=<?=$row['id']?>"><img src="images/icon3.png"/></a>
                                    <a title="Xóa" href="admin.php?act=shop_post&action=del&page=<?=$_REQUEST['page']?>&id=<?=$row['id']?>" onclick="return confirm('Bạn chắc chắn muốn xoá?');"><img src="images/icon4.png" width="20" border="0"/></a>
                                </td>
                            </tr>
                        <?php }?>
                        </tbody>
