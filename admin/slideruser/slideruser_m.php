...
if (isset($_POST['btnSave'])){
	...
	if ($errMsg == '')
		echo '<script>window.location="admin.php?act=slideruser&cat='.$_REQUEST['cat'].'&page='.$_REQUEST['page'].'&code=1"</script>';
}else{
	if (isset($_GET['id'])){
		$oldid=$_GET['id'];
		$page = $_GET['page'];
        ...
        <div class="box-widget">
            ...
            <div class="widget-container">
                <div class="widget-block">
                   ...
                   <form method="post" name="frmForm" enctype="multipart/form-data" action="admin.php?act=slideruser_m">
            ...
            <input type="hidden" name="act" value="slideruser_m">
