...
<form method="POST" action="#" name="frmForm" enctype="multipart/form-data">
    ...
    <table width="100%"   class="admin_table">
        ...
        <tr align="center" >
            <td valign="middle" style="background-color:#F0F0F0; height:40px; padding-left:20px" colspan="10">
                ...
                <select name="ddCat" id="ddCat" class="list_tim_loc table_list">
                    ...
                    <?php
                    $gt=get_records("tbl_shop_category","parent=390 and status=0","name COLLATE utf8_unicode_ci"," "," ");
        ...
        $sql="select *,DATE_FORMAT(date_added,'%d/%m/%Y %h:%i') as dateAdd,DATE_FORMAT(last_modified,'%d/%m/%Y %h:%i') as dateModify from tbl_shop_category where cate=3 and $where $sortby   limit ".($startRow).",".$pageSize;
