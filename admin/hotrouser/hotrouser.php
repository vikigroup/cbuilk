<?php
if(isset($frame)==true){
	check_permiss($_SESSION['kt_login_id'],25,'admin.php');
}else{
        ...
        <div class="box-widget">
            ...
            <div class="widget-container">
                <div class="widget-block">
                        ...
                        <form method="POST" action="admin.php?act=hotrouser" name="frmForm" enctype="multipart/form-data">
                            <input type="hidden" name="page" value="<?=$page?>">
                            <input type="hidden" name="act" value="hotrouser">
                            ...
                            <thead>
                               ...
                               <tr>
                                 ...
                                 <td width="102" align="center" colspan="1">
                                  <div><a href="admin.php?act=hotrouser_m">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td align="center">
                                            <a href="admin.php?act=hotrouser_m&cat=<?=$_REQUEST['cat']?>&page=<?=$_REQUEST['page']?>&id=<?=$row['id']?>"><img src="images/icon3.png"/></a>
                                            <a  title="Xóa" href="admin.php?act=hotrouser&action=del&page=<?=$_REQUEST['page']?>&id=<?=$row['id']?>" onclick="return confirm('Bạn có muốn xoá luôn không ?');" ><img src="images/icon4.png" width="20" border="0" /></a><!--./?act=hotro_category&action=del&page=<?=$_REQUEST['page']?>&id=<?=$row['id']?>-->
                                        </td>
                                    </tr>
                                 <?php }?>  
