                ...
                <div class="widget-block">
						...
						<?
                            ...
                            <thead>
                                ...
                                <tr align="center" >
                                  <td valign="middle" style="background-color:#F0F0F0; height:40px; padding-left:20px" colspan="11"><input class="table_khungnho"  name="tukhoa" id="tukhoa" type="text" value="<?=$tukhoa?>"  placeholder="Từ khóa" />
                               ...
                               <tr>
                                ...
                                <tr class="admin_tieude_table">
											...
											<td width="10%" align="center"><span class="title"><a class="title" href="<?=getLinkSort(3)?>">Tên thành viên</a></span></td>
											<td width="7%" align="center"><a class="title" href="<?=getLinkSort(4)?>">Username</a></td>
											<td width="9%" align="center"><a class="title" href="<?=getLinkSort(10)?>">Hình ảnh</a></td>
										...
										<tr>
											...
											<a href="?act=user_permiss&id=<?php echo $row['id'];?>">
												<?php
													...
													elseif($row['idgroup']==2){echo 'Mode';}
													elseif($row['idgroup']==3){echo 'Admin';}
												  ?>
											</a>
											</td>
