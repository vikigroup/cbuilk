                ...
                <? if ($_REQUEST['code']==1) $errMsg = 'Cập nhật thành công.'?>
                  ...
                  <table width="100%"   class="admin_table">
                        	...
                        	<tr align="center" >
                                ...
                                <tr align="center" >
                                  <td valign="middle" style="background-color:#F0F0F0; height:40px; padding-left:20px" colspan="10">  
                                        ...
                                        <select name="ddCat" id="ddCat" class="list_tim_loc table_list">
                                            ...
                                            <?php   
											$gt=get_records("tbl_shop_category","parent=2 and status=0 and cate=0","name COLLATE utf8_unicode_ci"," "," ");
                                ...
                                <tr>
                                 ...
                                 <td width="80" align="center" colspan="1">
                                  <div><a href="admin.php?act=shop_category_m">
						...
						$direction=($_REQUEST['direction']==''||$_REQUEST['direction']=='0'?"desc":"");
						 ...
						 $sql="select *,DATE_FORMAT(date_added,'%d/%m/%Y %h:%i') as dateAdd,DATE_FORMAT(last_modified,'%d/%m/%Y %h:%i') as dateModify from tbl_shop_category where $where and cate=0 $sortby   limit ".($startRow).",".$pageSize;
