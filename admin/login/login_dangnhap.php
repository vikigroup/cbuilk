...
<form id="form1" name="form1" method="post" action="">
			Tên Đăng Nhập:<br />
       <input name="username" type="text" class="text" id="username" title="Nhập tên đăng nhập của bạn" value="<?php  echo $_COOKIE['un'];?>"/>
            <br /> <span class="coloi_hien"> <?php echo $error_username1;?></span><br />
             Mật Khẩu:<br />  
