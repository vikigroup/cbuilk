            ...
            <div class="main_f_dn">
                ...
                <div class="main_f_tt">
                    ...
                    <div class="module_ftt">
                        ...
                        <div class="r_f_tt" >
                            <div style="position:relative;">
                            	<input required class="ipt_f_tt" type="text" name="tendk" value="<?php echo $tendk; ?>" />
                            	<span id="error" style="position:absolute; top:7px; " > Loi</span>
                    ...
                    <div class="module_ftt">
                        ...
                        <div class="r_f_tt">
                            <input style="width:100px;" required  name="cap" value="<?php echo $cap; ?>" class="ipt_f_tt" type="text"/>
                                <div class="img_capcha" style="width:80px;">
