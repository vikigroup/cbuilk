...
if(isset($_REQUEST['order'])) {
    ...
    if($coloi==FALSE) {
        ...
        $vale1='idshop,price,idKH,soDT,ThoiDiemDatHang,TenNguoiNhan,DiaChi,yahoo,TinhTrang,thanhtoan,GhiChu';
        $vale2="'".$idshop."','".$total."','".$idKH."','".$dt."','".$ngay."','".$name."','".$dc."','".$yahoo."','','','Giohang_".$tenmien."'";
        $hinh="";
                        ...
                        <table width="100%" cellspacing="0" class="sty_table_rv">
                            ...
                            while( key($_SESSION['daySoluong'])!= null)
                            {
                                ...
                                <tr>
                                    ...
                                    <td align="center"><img width="100"  height="100" src="<?php echo $host_link_full ;?>/<?=$url1?>" alt=""> </td>
                                    <td align="center">
